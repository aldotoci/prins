...
<aside id="side-nav" class="side-nav" tabindex="-1">
    <div class="side-nav__scrollable-container">
        <div class="side-nav__wrap">
            ...
            <!--                    </label>-->
            <!--                    <input type="search" id="search-form-1" class="search-field" placeholder="Search &hellip;" value=""-->
            <!--                           name="s"/>-->
            <!--                    <button type="submit" class="search-submit">-->
            <!--                        <svg class="svg-icon svg-icon-search" aria-hidden="true" role="img" focusable="false"-->
            ...
            <div id="contact">
                <div id="text-7" class="widget widget_text"><h3 class="title">Find Us</h3>
                    <div class="social-media-logos">
                        <a target="_blank" href="https://www.instagram.com/prins_autogassystems_albania/">
                            <img width="40" src="./images/insta_icon.webp">
                        </a>
                    ...
                    <div class="textwidget">
                        ...
                        <p><strong>Hours</strong><br/>
                            Monday&ndash;Saturday: 9:00AM&ndash;5:00PM</p>
                        <p><strong>Phone Number</strong><br/>
                            <a href="tel:+1234567890">+355 69 215 1905</a></p>
                    </div>
                    <div class="clear"></div>
                </div>
            </div>
...
<div id="page" class="site">
        ...
        <div id="site-navigation" class="navbar">
            <div class="header-inner inner-wrap  ">
                ...
                <div class="header-logo-wrapper">
                    <a href="http://localhost" title="" class="custom-logo-text">
                        <img width="150px" src="./images/logo.svg"
                             alt="Prins alternative fuel systems &amp; components">
                    </a></div>
                        ...
                        <form method="get" id="searchform" action="http://localhost/">
                            <label for="search-form-input">
                                ...
                                <input type="search" class="sb-search-input"
                                       placeholder="Type your keywords and hit Enter..." name="s" id="search-form-input"
                                       autocomplete="off"/>
                            </label>
                            <button class="sb-search-button-open" aria-expanded="false">
		<span class="sb-icon-search">
			<svg class="svg-icon svg-icon-search" aria-hidden="true" role="img" focusable="false"
                 xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23"><path
                    d="M38.710696,48.0601792 L43,52.3494831 L41.3494831,54 L37.0601792,49.710696 C35.2632422,51.1481185 32.9839107,52.0076499 30.5038249,52.0076499 C24.7027226,52.0076499 20,47.3049272 20,41.5038249 C20,35.7027226 24.7027226,31 30.5038249,31 C36.3049272,31 41.0076499,35.7027226 41.0076499,41.5038249 C41.0076499,43.9839107 40.1481185,46.2632422 38.710696,48.0601792 Z M36.3875844,47.1716785 C37.8030221,45.7026647 38.6734666,43.7048964 38.6734666,41.5038249 C38.6734666,36.9918565 35.0157934,33.3341833 30.5038249,33.3341833 C25.9918565,33.3341833 22.3341833,36.9918565 22.3341833,41.5038249 C22.3341833,46.0157934 25.9918565,49.6734666 30.5038249,49.6734666 C32.7048964,49.6734666 34.7026647,48.8030221 36.1716785,47.3875844 C36.2023931,47.347638 36.2360451,47.3092237 36.2726343,47.2726343 C36.3092237,47.2360451 36.347638,47.2023931 36.3875844,47.1716785 Z"
                    transform="translate(-20 -31)"/></svg>		</span>
                            </button>
                            <button class="sb-search-button-close" aria-expanded="false">
		<span class="sb-icon-search">
			<svg class="svg-icon svg-icon-cross" aria-hidden="true" role="img" focusable="false"
                 xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><polygon fill=""
                                                                                                        fill-rule="evenodd"
                                                                                                        points="6.852 7.649 .399 1.195 1.445 .149 7.899 6.602 14.352 .149 15.399 1.195 8.945 7.649 15.399 14.102 14.352 15.149 7.899 8.695 1.445 15.149 .399 14.102"/></svg>		</span>
                            </button>
                        </form>
                    </div>
    ...
    <div class="custom-header">
        ...
        <div class="custom-header-media">
            <div id="wp-custom-header" class="wp-custom-header">
                <video id="wp-custom-header-video" autoplay="autoplay" loop="" playsinline="true" width="2000"
                       height="1200"
                       src="./images/Royalty%20Free%20Forest%20Road%20Aerial%20Stock%20Video%20Footage%201.webm"></video>
                <button type="button" id="wp-custom-header-video-button"
                        class="wp-custom-header-video-button wp-custom-header-video-play"><span
    ...
    <div class="site-content-contain">
            ...
            <main id="main" class="site-main" role="main">
                <article id="post-12" class="post-12 page type-page status-publish has-post-thumbnail hentry">
                    ...
                    <header class="entry-header">
                        ...
                        <div class="inner-wrap"><h1 class="entry-title">Sistemet tona.</h1></div><!-- .inner-wrap -->
                    </header><!-- .entry-header -->
                    ...
                    <div class="entry-content">
                        ...
                        <p class="has-text-align-center">
                            <meta charset="utf-8">
                            Ne ofrojmë zgjidhje të ndryshme për konvertimin e mjeteve në LPG, CNG ose LNG. Falë gamës sonë të gjerë të produkteve, ne mund të instalojmë një nga sistemimet tona të karburantit në (pothuajse) të gjitha makinat, autobusët, kamionët dhe pikapët. Madje, mund të ofrojmë konvertime edhe për aplikacione industriale dhe detare.

                            Pasi që kemi qenë të përqendruar kryesisht në sistemet universale në fillim, tani ne po kthehemi në përqendrimin e specifikës përmes integrimit sipas markës dhe modelit të makinës.

                            Numri i sistemeve të disponueshme LPG dhe CNG për makinat me sistem karburanti DI (injeksion direkt) po rritet shumë shpejt. Falë programit të dorëzimit të gjërë dhe përvojës sonë në të ditur cilat sisteme punojnë më mirë për një motor të caktuar, ne mbajmë një pozitë unike drejtuese në treg. Zbuloni cilin sistem i përshtatet makinës suaj duke përdorur tonën.
                            <a href='https://www.prinsautogas.com/en/vehicle-database#wdt-find-system-field-make'
                               target="_blank">Databasen për Mjetet.</a>.
                        </p>
                        ...
                        <div class="type-of-systems">
                            <div onclick="document.getElementById('VSI-3').scrollIntoView()" class="wrapper vsi">
                                <div class="container ">
                                    ...
                                    <div property="schema:text"
                                        ...
                                        Sistemi VSI është sistemi më i avancuar i injeksionit të avullit në treg. Së pari, është zhvilluar nga Prins dhe tani është rishikuar plotësisht për të përshtatur me motorët modernë të avancuar.
                                    </div>
                                </div>
                            </div>
                            <div onclick="document.getElementById('VSI-DI').scrollIntoView()" class="wrapper vsi-di">
                                <div class="container ">
                                    ...
                                    <div property="schema:text"
                                         class="field--label-hidden">
                                        Numri i sistemeve LPG dhe CNG për makinat të pajisura me një motor me injeksion direkt po rritet me shpejtësi. Falë gamës sonë të gjërë të produkteve, ne jemi një pioneër në treg.
                                    </div>
                                </div>
                            </div>
                            <div onclick="document.getElementById('VSI').scrollIntoView()" class="wrapper dieselblend">
                                <div class="container ">
                                    ...
                                    <div property="schema:text"
                                         class="field--label-hidden">
                                        Sistemi i Karburantit Dyfishek Prins Dieselblend është një sistem karburant inovativ. Në motorët diesel, ky sistem bën të mundur zëvendësimin e një pjese të naftës dizel me LPG (bio), CNG, LNG ose Hidrogjen H2 më të pastër dhe më të lirë."
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <article class="post-12 page type-page status-publish has-post-thumbnail color-background hentry">
            ...
            <div class="entry-content">
                <div class="content-container VSI-detail-container">
                    <div>
                        <p class="VSI--1">Sistemi VSI është sistemi më i avancuar i injektimit të avullit në treg. Ai u zhvillua fillimisht nga Prins dhe tani është plotësisht rindërtuar për të përshtatur me motorët moderne të avancuar. Të gjithë komponentët që përdoren në sistemin VSI plotësojnë standardet më kërkesa dhe certifikimet më të larta. </p>
                        <p class="VSI--2">Sistemi VSI-DI bazohet në parimin e konvertimit të gazit të lëngëzuar të naftës ose gazit natyror (<a href="https://www.prinsautogas.com/en/cng">CNG</a>) në formë avulli para se ta injektojë në mënyrë të ndjekshme në një motor me injeksion direkt. Ne gjithashtu ofrojmë zgjidhje për makinat me një sistem karburanti me <a href="https://www.prinsautogas.com/en/vsi-20-di-system" target="_blank">injeksion direkt!</a></p>
                    </div>
                    <ul>
                        <li class="VSI--1">Komponentë cilësorë të lartë</li>
                        <li class="VSI--1">Software unik i diagnostikimit</li>
                        <li class="VSI--1">Performancë optimale</li>
                        <li class="VSI--1">Emetime të reduktuara</li>
                        <li class="VSI--1">Asnjë ndryshim i dukshëm krahasuar me përdorimin e makinës suaj me benzinë!</li>
                    </ul>
                </div>
            </div><!-- .entry-content -->
        </article><!-- #post-12 -->
        ...
        <article id="VSI" class="post-12 page type-page status-publish has-post-thumbnail hentry">
            <div class="entry-content">
                <h3 class="VSI--1" style="text-align: center;">Në vijim janë komponentët kryesorë që shtohen në makinën tuaj kur vihet në funksion konvertimi në LPG.</h3>
        ...
        <article id="VSI-DI" class="post-12 page type-page status-publish has-post-thumbnail color-background hentry">
            ...
            <div class="entry-content">
                <h3 style="text-align: center;">Konvertimi në LPG (autogaz) | Volkswagen Golf 8 1.5 TSI</h3>
                <div class="content-container yt-frame-container">
        ...
        <article class="post-12 page type-page status-publish has-post-thumbnail hentry">
            <div class="entry-content">
                <div class="content-container VSI-detail-container">
                    <div>
                        <p><strong>VSI</strong> stands for "Vapour Sequential Injection". The VSI-DI system is a derivative of the VSI
                            system and is specially developed for cars with a Direct Injection fuel system (DI engine).</p>

                        <p><strong>Ngarkesa e krahasuar me konkurrentët në treg, Prins ofron sisteme karburanti të besueshme për një
                                shkallë të gjerë të mjeteve. Këto sisteme VSI-DI konsumojnë shumë pak benzinë (< 5%), dhe janë të
                                përshtatshme për të gjitha llojet e makinave, si për modele të fundit ashtu edhe për makinat që kanë qenë
                                në rrugë për disa vite.</strong></p>
                        <p>Sistemi VSI-DI bazohet në parimin e konvertimit të gazit të naftës të lëngshme (LPG) ose gazit natyror
                            (CNG) në formë avulli para injektimit sekencial në një motor DI (me injeksion direkt).</p>
                    </div>
                    <ul>
                        <li>Software më i përparuar</li>
                        <li>Posaçërisht për motorët me injeksion direkt</li>
                        <li>Komponentë cilësorë të lartë</li>
                        <li>Performancë maksimale, emetime minimale</li>
                        <li>Konsum benzinë shumë i ulët (< 5%)</li>
                        <p>Nuk ka ndryshim të dukshëm krahasuar me qëllimin e makinës tuaj me benzinë!
                        </p>
                    </ul>
                </div>
            </div><!-- .entry-content -->
        ...
        <article id="VSI-3" class="post-12 page type-page status-publish has-post-thumbnail color-background hentry">
            <header class="entry-header">
                <div class="inner-wrap"><h1 class="entry-title">VSI-3 DI: Sistemi revolucionar i GPL</h1></div>
                <!-- .inner-wrap -->
            </header><!-- .entry-header -->
            <div class="entry-content">
                <h3 style="text-align: center;">Ju prezantojmë sistemin revolucionar VSI-3 DI LPG</h3>
                <div class="content-container yt-frame-container">
        ...
        <div class="wp-block-group alignfull is-layout-flow">
            <div class="wp-block-group__inner-container">
                <div class="wp-block-columns are-vertically-aligned-center is-layout-flex wp-container-12">
                    ...
                    <div class="wp-block-column is-vertically-aligned-center is-layout-flow">
                        <h2 class="wp-block-heading">Ju prezantojmë sistemin revolucionar VSI-3 DI LPG</h2>
                        <h4>Ky sistem LPG është unik dhe i ardhshëm, ofron një zgjidhje të përgjithshme për një shumëllojshmëri të gjerë të
                            mjeteve me teknologji automobilistike të fundit, që përputhet me standardet globale të emetimeve.</h4>
                        <p>Sistemi Prins VSI-3 DI LPG ofron një zgjidhje të përgjithshme për një shumëllojshmëri të gjerë të mjeteve me
                            teknologji automobilistike të fundit, duke përputhur me standardet globale të emetimeve të fundit si Euro 6D
                            WLTP dhe certifikimet si R115/EPA. Sistemi është i cilësisë së lartë, shumë efikas (përdorimi i petrolit <5%),
                            me performancë më të lartë, ofron një përvojë të qetë të vozitjes, pikërisht si një mjet benzinë normal.
                            Duke udhëtuar me LPG (Autogaz), ju kurseni kostot e karburantit, ndonjëherë qindra euro në vit, dhe ndihmoni
                            në ruajtjen e mjedisit duke ulur CO2 (21%) dhe emetimet e ndërlikta (deri në 95%). Sistemi është tani
                            i disponueshëm në të gjithë botën, tek instaluesit zyrtarë të Prins.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <aside class="footer-widgets widgets widget-columns-3" role="complementary" aria-label="Footer">
                    ...
                    <div class="widget-column footer-widget-2">
                        <section id="text-9" class="widget widget_text"><h2 class="title">About This Site</h2>
                            <div class="textwidget">
                                <p>Ky mund të jetë një vend i mirë për t'u prezantuar veten dhe faqen tuaj ose për të përfshirë disa kredite.</p>
                            </div>
                        </section>
                    </div>
...
<script src='./js/custom-header-vimeo.min.js' id='wp-custom-header-vimeo-js'></script>
</body>
</html>
