<!DOCTYPE html>
<html lang="en-US" translate="es" class="no-js" >
<head>
    <!-- Favicon config    -->
                        ...
                        <div class="entry-content">
                                ...
                                <div class="wp-block-group__inner-container">
                                    <div class="wp-block-columns is-layout-flex wp-container-7">
                                        <div class="wp-block-column is-vertically-aligned-center is-layout-flow">
                                            <h2 class="wp-block-heading">Rreth nesh</h2>
                            ...
                            <div class="wp-block-group alignfull is-layout-flow">
                                <div class="wp-block-group__inner-container">
                                    <div class="wp-block-columns are-vertically-aligned-center is-layout-flex wp-container-12">
                                        ...
                                        <div class="wp-block-column is-vertically-aligned-center is-layout-flow">
                                            <h2 class="wp-block-heading">Ne do të gjejmë sistemin e duhur të karburantit për ju.</h2>
                                            <p>Do të ju ndihmojmë të gjeni sistemin e duhur të karburantit për makinën tuaj, të sigurojmë një kuotë për instalimin dhe t'ju çojmë në rrugën e kursimit të parave në karburant menjëherë.</p>
                                            ...
                                            <p>
                                                <small>
                                                    Ju lutemi na kontaktoni nëse mjeti juaj nuk është në listë ose nëse jeni të interesuar për një sistem LNG.
                                                </small>
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="wp-block-group alignfull has-background is-layout-flow"
                                ...
                                <div class="wp-block-group__inner-container">
                                    <div class="wp-block-columns is-layout-flex wp-container-7">
                                        <div class="wp-block-column is-vertically-aligned-center is-layout-flow">
                                            <h2 class="wp-block-heading">Ku mund të na gjeni?</h2>
                                            ...
                                            <div class="wp-block-buttons is-horizontal is-content-justification-left is-layout-flex wp-container-4">
                                                <div class="wp-block-button is-style-outline"><a
                                                        ...
                                                        href="https://goo.gl/maps/5dNpVL4FFKFY3sbU7?coh=178571&entry=tt">Hap Harten</a></div>
                                            </div>
                            ...
                            <div class="wp-block-cover alignfull has-parallax is-position-center-center"
                                ...
                                <div class="wp-block-cover__inner-container">
                                    <p class="has-text-align-center has-text-color has-huge-font-size"
                                       style="color:#fffffa;line-height:1.1"><strong>Lironi fuqinë e Gazit Natyror, një karburant miqësor ndaj mjedisit dhe i kostos efikase, për performancën efikase të makinës suaj dhe ndikimin e ulët të karbonit.</strong></p>
                                    ...
                                    <div class="wp-block-buttons is-horizontal is-content-justification-center is-layout-flex wp-container-17">
                                        <div class="wp-block-button is-style-outline"><a
                                                ...
                                                href="#about-section">Na kontaktoni.</a></div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="inner-wrap">
                    <aside class="footer-widgets widgets widget-columns-3" role="complementary" aria-label="Footer">
                        <div class="widget-column footer-widget-1">
                            <section id="text-8" class="widget widget_text"><h2 class="title">Na gjeni në</h2>
                                <div class="social-media-logos">
                                    <a target="_blank" href="https://www.instagram.com/prins_autogassystems_albania/">
                                        <img width="40" src="./images/insta_icon.webp">
                                    </a>
                                ...
                                <div class="textwidget">
                                    ...
                                    <p><strong>Hours</strong><br/>
                                        Monday&ndash;Saturday: 9:00AM&ndash;5:00PM</p>
                                    <p><strong>Numri i telefonit</strong><br/>
                                        <a href="tel:+1234567890">+355 69 215 1905</a></p>
                                </div>
                            </section>
                        </div>
                        <div class="widget-column footer-widget-2">
                            <section id="about-section" class="widget widget_text"><h2 class="title">Rreth kesaj faqje.</h2>
