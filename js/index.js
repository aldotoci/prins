const languagesList = ["Shqip", "English"];
...
const languageButtons = Array.from(
  document.getElementsByClassName("languageButton")
);
languageButtons.forEach((node) => node.addEventListener("click", onLanguage));

const stringShqipLanguage = {
  "VSI--1":
    "VSI nënkupton . Sistemi VSI është sistemi më i avancuar i injektimit të avullit në treg. Ai u zhvillua fillimisht nga Prins dhe tani është plotësisht rindërtuar për të përshtatur me motorët moderne të avancuar. Të gjithë komponentët që përdoren në sistemin VSI plotësojnë standardet më kërkesa dhe certifikimet më të larta.",
  "VSI--2":
    "Sistemi VSI bazohet në parimin e shndërrimit të gazit të naftës së lëngshme (LPG) ose gazit natyror (CNG) në formë avulli para se të injektohet secilën në motor në mënyrë sekuencale. Ne gjithashtu ofrojmë zgjidhje për makinat me sistem të drejtpërdrejtë të injektimit të karburantit! ",
  "VSI--3": "Komponentë të cilësisë së lartë",
  "VSI--4": "Softuer diagnostik unik",
  "VSI--5": "Performancë optimale",
  "VSI--6": "Emetime të ulëta",
  "VSI--7":
    "Nuk ka ndryshim të dukshëm krahasuar me përdorimin e automjetit tuaj me benzinë!",
  "VSI--8":
    "Në vijim janë komponentët kryesorë që shtohen në makinën tuaj kur instalohet një konvertim LPG.",
  "VSI--9":
    "Komponentët që përbëjnë sistemin tonë VSI LPG shfaqen më poshtë. Komponentët kryesorë përmbushin të njëjtat standarde si pjesët OEM dhe janë zhvilluar posaçërisht për sistemet LPG dhe CNG. Ata plotësojnë standardet më kërkesa dhe certifikimet më të larta.",
  "VSI--10": "Tanku LPG",
  ...
  "VSI-DI--1":
    'VSI nënkupton "Injektim Sekuencial të Avullit". Sistemi VSI-DI është një derivat i sistemit VSI dhe është zhvilluar veçanërisht për makinat me sistem të drejtpërdrejtë të injektimit të karburantit (motor DI).',
  "VSI-DI--2":
    "Në krahasim me konkurrentët në treg, Prins ofron sisteme të besueshme të karburantit për një gamë të gjerë të mjeteve. Këto sisteme VSI-DI konsumojnë shumë pak benzinë (<5%) dhe janë të përshtatshme për të dy llojet më të fundit të makinave dhe makinat që kanë qenë në rrugë për disa vjet.",
  "VSI-DI--3":
    "Sistemi VSI-DI bazohet në parimin e shndërrimit të gazit të naftës së lëngshme (LPG) ose gazit natyror (CNG) në formë avulli para se të injektohet në makinën me motor DI në mënyrë sekuencale.",
...
const translations = {
  ...
  // Initial translation (default language)
  translatePage('en');
  
  // Toggle language event handler
  const languageSwitch = document.getElementById('language-switch');
  languageSwitch.addEventListener('click', () => {
    const currentLanguage = languageSwitch.textContent.toLowerCase();
    const newLanguage = (currentLanguage === 'english') ? 'sq' : 'en';
    translatePage(newLanguage);
    languageSwitch.textContent = (currentLanguage === 'english') ? 'Shqip' : 'English';
  });
